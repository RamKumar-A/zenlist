...
function MyDayPage() {
  ...
  return (
    <div className="grid h-[100vh] place-self-auto grid-rows-[1fr_auto] dark:bg-gray-950 md:bg-gray-100 relative md:mx-2  md:px-5 lg:mx-20 xl:mx-40 p-2">
      <div>
 ...
 md:h-28 md:flex-col md:w-1/4 items-center justify-center mb-5 mx-3 rounded-md shadow-lg shadow-gray-700 dark:shadow-gray-500"
      ...
      <div className=" rounded-lg m-1">
        <div className="bg-gray-100 dark:bg-gray-950 w-full rounded-lg relative sm:h-full min-[385px]:h-[85dvh] grid h-[78dvh] grid-rows-[1fr_auto]">
          <div className="w-full mt-auto xl:h-[389px] overflow-y-auto h-full mb-2">
            <MydayTasks />
          </div>
          <div className="taskAddInputDiv top-1.5 sm:mt-3">
            <TaskAddInput />
            {/* top-1.5 sm:mt-3 */}
          </div>
        </div>
